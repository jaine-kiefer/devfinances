...
const Transaction = {
    ...
    incomes () {
        let income = 0;
        // somar as entradas que são maiores que zero, somar a uma variavel e retornar a variavel
    ...
    expenses () {
        // somar as saídas
        let expense = 0;
        // somar as saídas que são menores que zero, somar a uma variavel e retornar a variavel
        Transaction.all.forEach(transaction => {
            if (transaction.amount < 0) {
...
const DOM = {
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        <td>
            <img onclick="Transaction.remove(0)"(${index}) src="./assets/minus.svg" alt="Remover transação">
        </td>
        `
